...
class MJCS_Scraper:
    ...
    def accept_disclaimer(self):
        ...
        c = [self.session.cookies.set(c['name'], c['value'])
    ...
    def search_case_id(self, case_id):
        ...
        submit_case = self.driver.find_element_by_xpath(
            "//*[@name='action' and @value='Get Case']"
        )
        submit_case.click()
        ...
        # Return to Search
        self.driver.get(
            "http://casesearch.courts.state.md.us/casesearch/goBackLink.jis"
            )
